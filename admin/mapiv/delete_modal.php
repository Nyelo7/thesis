...
<div id="deleteModal" class="modal-overlay">
    <div class="modal-content">
        <div class="modal-title" id="modalMessage">Archive this person from Floor ?</div>
        <div class="modal-buttons">
            <button class="modal-btn modal-btn-cancel" onclick="closeDeleteModal()">Cancel</button>
            <button class="modal-btn modal-btn-delete" id="confirmDeleteBtn">Archive</button>
        </div>
    </div>
</div>
...
function showDeleteModal(personId, floorNumber) {
    ...
    message.textContent = `Archive this person from Floor ${floorNumber}?`;
